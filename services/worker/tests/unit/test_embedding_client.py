"""Tests for worker.bootstrap.embedding_client — PR #19a Group A.

Every llm-proxy status class from the D5/D9 lock is exercised end-
to-end via ``httpx.MockTransport`` so the worker side of the
embedding contract is pinned without a live llm-proxy.
...
SENTINEL = "CANARY-WORKER-EMBED-PR19A-ZZ9"
