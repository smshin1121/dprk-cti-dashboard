...
export function ReportsYearJumpSelect(): JSX.Element {
  ...
  return (
    <label className="flex items-center gap-2 text-xs font-cta uppercase tracking-caption text-ink-muted">
      <span>Year</span>
      <select
        ...
        className="rounded-input border border-border-card bg-app px-2 py-1 text-xs font-body normal-case tracking-normal text-ink hover:border-border-strong focus:outline-none focus:ring-2 focus:ring-ring"
      >
